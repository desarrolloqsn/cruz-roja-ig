...
import json from './../../datos/datos_globales_grafo_bigramas_freq.json'
import './Graficos.css'
import { MdOpenInNew } from 'react-icons/md'

export default function GrafoBigramas() {
...
// create an array with edges
  ...
  return <div>
    <div className='titulo-carta'>Grafo bigramas frecuentes</div>
  ...
  <div className='subtitulo-carta'>
    ...
    <a href={`https://qsngrafos.vercel.app/palabras/cruz-roja-ig/grafo_palabras-frecuentes-${filtroFecha}.html`} target="_blank"><Button  shape="circle">
        <MdOpenInNew/>
    </Button>
     </a>
  </Tooltip>
 ...
 <div id="bigramas" style={{backgroundColor:"#000041", height:"300px", borderRadius:"10px"}}></div>
</div>
</div>
};
